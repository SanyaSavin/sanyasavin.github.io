...
<?php endif; ?>
	...
	function renderFileRow(data) {
		...
		if(data.is_writable) perms.push('изменение');
	...
	function renderBreadcrumbs(path) {
		var base = "",
			$html = $('<div/>').append( $('<a href=#>Главная папка</a></div>') );
...
<div id="top">
   <?php if($allow_create_folder): ?>
	<form action="?" method="post" id="mkdir" />
		<label for=dirname>Имя папки</label><input id=dirname type=text name=name value="" />
...
<footer>Локальное файловое хранилище ПСХТ</footer>
</body></html>
